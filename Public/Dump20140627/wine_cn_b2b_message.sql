...
--
-- Table structure for table `b2b_message`
--
...
CREATE TABLE `b2b_message` (
  ...
  `msg_contact` varchar(45) NOT NULL,
  `msg_tel` varchar(45) DEFAULT '0',
  `msg_item` varchar(45) DEFAULT '0',
  `msg_content` tinytext,
  `msg_source` varchar(45) DEFAULT '0',
  `msg_time` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='B2B.WINE.CN 留言薄';
